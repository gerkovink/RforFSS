...
to a readable file where code and output are visible. There is, however, an even better format to integrate `R`-code with text into a single document: [Markdown!](https://rmarkdown.rstudio.com)

---

11. **Open the file `markdown.Rmd`. **

Have a look at the code in the script and figure out the structure of the `markdown` file. If you do not understand what you are looking at, please ask me. 
