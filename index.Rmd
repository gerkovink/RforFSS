...
- Part A: Introduction to scripting with `R`
    ...
    - [Video discussion](https://www.dropbox.com/s/qgxlrrl808klmjq/Exercise1_discussion.mp4?dl=0)
...
- Part B: Objects and Elements
    ...
    - [Video discussion](https://www.dropbox.com/s/7bxqj6gn7occ0yr/Exercise%202_discussion.mp4?dl=0)
...
- Part C: Statistical learning 
    - [Lecture C link](Part C - Model estimation/Lecture_C.html)
...
I usually adapt the course as we go. To ensure that you work with the latest iteration of the course materials, I advice all course participants to access the materials online. At the end of the course, you can download all course materials [here](Archive.zip). 
...
- [This book seems written for people who use STATA a lot](https://www.econometrics-with-r.org/7-3-joint-hypothesis-testing-using-the-f-statistic.html)
...
Have a look at the materials for the [R Summerschool](https://www.gerkovink.com/R/) course. This course details materials that start from a beginner level. 
